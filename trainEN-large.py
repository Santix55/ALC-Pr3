...
def main():
    ...
    def objective(trial):
        ...
        batch_size = trial.suggest_categorical('batch_size', [2,4])  # Ajustar tamaños de batch
    ...
    study.optimize(objective, timeout=30*60)   # Only 1 hour
